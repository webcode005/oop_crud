<?php 
   ...
   $for_all_records = $my_obj->showall();

   
    // for add record

    if (isset($_POST["submit"])) {
        $addrecord = $my_obj->add();
    }
            ...
            <div class="table-responsive">
               <table class="table" border="1">
                  ...
                  <tbody>
                     <?php 
                        $ik='1';
                        foreach($for_all_records as $student_records){
                                             
                        
                        ?>
                     <tr>
                        <td class="text-center"><?php echo $ik++;?></td>
                        <td><?php echo $student_records['name'];?></td>
                        <td><?php echo $student_records['email'];?></td>
                        <td><?php echo $student_records['mobile'];?></td>
                        <td class="text-right"><?php echo $student_records['create_date'];?></td>
                        <td class="td-actions text-right">
                           <!-- <button type="button" rel="tooltip" class="btn btn-info btn-just-icon btn-sm" data-original-title="" title="">
                           <i class="material-icons">person</i>
                           </button> -->
                           <a href="edit.php?id=<?php echo $student_records['id'];?>"  rel="tooltip" class="btn btn-success btn-just-icon btn-sm" data-original-title="" title="">
                           <i class="material-icons">edit</i>
                           </button>
                           <a href="?id=<?php echo $student_records['id'];?>" rel="tooltip" class="btn btn-danger btn-just-icon btn-sm" data-original-title="" title="">
